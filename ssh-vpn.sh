...
wget -q -O /usr/local/bin/ws-stunnel "https://${Server_URL}/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://${Server_URL}/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://${Server_URL}/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/issue.net "https://${Server_URL}/issue.net"
